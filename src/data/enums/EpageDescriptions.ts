export const EpageDescriptions = {
  LOGIN: 'Seu copiloto de vendas impulsionado por IA',
  ADMIN_DASHBOARD: 'Visão geral da plataforma SalesPilot',
  MANAGER_DASHBOARD: 'Visão geral da empresa',
