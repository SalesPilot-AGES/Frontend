...
import { useGetSalesmenStatus } from '@services/queries/useDashboard';
import { EmptyState } from '@UI/EmptyState/EmptyState';
import type { JSX } from 'react';
import { useMemo } from 'react';

const CHART_TITLE = 'Vendedores ativos';
const EMPTY_STATE_TITLE = 'Nenhum vendedor encontrado';
const EMPTY_STATE_DESCRIPTION = 'Não há dados de vendedores para exibir.';
const LABEL_ACTIVE = 'Ativos';
const LABEL_INACTIVE = 'Inativos';

export const SalesmenStatusChart = (): JSX.Element => {
  const { palette } = useTheme();
  const { data, isLoading } = useGetSalesmenStatus();
